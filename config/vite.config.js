    ...
    return {
        plugins: [
            ...
            VitePWA({
                ...
                manifest: {
                    name: env.VITE_APP_NAME || 'Better Civ5',
                    short_name: env.VITE_APP_SHORT_NAME || 'BetterCiv5',
                    description: env.VITE_APP_DESCRIPTION || 'Une application web moderne pour explorer et comparer les civilisations de Civilization V',
                    theme_color: '#111010',
        ...
        define: {
            __APP_VERSION__: JSON.stringify(env.VITE_APP_VERSION || '1.2.0'),
